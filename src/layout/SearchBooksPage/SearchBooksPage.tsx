...
export const SearchBooksPage = () => {
    ...
    const [searchUrl, setSrearchUrl] = useState("");
    ...
    const searchHandleChange = () => {
        ...
        if(search === "") {
            ...
            setSrearchUrl(`/search/findByTitleContaining?title=${search}&page=<pageNumber>&size=${booksPerPage}`);
        }
    ...
    const categoryField = (value:string) => {
        ...
        if(
            ...
            setSrearchUrl(`/search/findByCategory?category=${value}&page=<pageNumber>&size=${booksPerPage}`);
        } else {
            setCategorySelection("All");
            setSrearchUrl(`?page=<pageNumber>&size=${booksPerPage}`);
        }
    }
